...
%token <string> T_FLOAT T_INT
%token <token> T_EQUAL T_PLUS T_MINUS T_STAR
%token <token> T_LBRACE T_RBRACE T_LPAREN T_RPAREN 
...
thingy:
        ...
        T_INT            { cout << "bison found an int: " << $1 << endl; }
        | T_FLOAT          { cout << "bison found a float: " << $1 << endl; }
