...
{
  "$end", "error", "$undefined", "LIT_FLOAT", "LIT_INT", "LIT_TRUE",
  "LIT_FALSE", "FLOAT", "INT", "BOOL", "VEC2", "VEC3", "VEC4", "IVEC2",
  "IVEC3", "IVEC4", "BVEC2", "BVEC3", "BVEC4", "VOID", "DP3", "LIT", "RSQ",
  "CONST", "IF", "ELSE", "WHILE", "ID", "EQ", "NE", "LT", "LE", "GT", "GE",
  "AND", "OR", "NOT", "'='", "'+'", "'-'", "'*'", "'/'", "'^'", "'('",
  "')'", "'['", "']'", "'{'", "'}'", "','", "';'", "$accept", "program",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     285,   286,   287,   288,   289,   290,   291,    61,    43,    45,
      42,    47,    94,    40,    41,    91,    93,   123,   125,    44,
      59
};
# endif
...
{
       4,     0,     2,     1,     6,     5,     7,     8,    11,     9,
      10,    12,    13,    14,    18,    19,    20,    15,    16,    17,
      21,    23,    24,    25,    26,    27,    28,    29,    22,    36,
